...
import { GiLibertyWing, GiPsychicWaves } from "react-icons/gi";
...
export const typeProperties = {
	...
	fighting: { color: "bg-green-500", icon: FaFire },
	...
	rock: { color: "bg-gray-500", icon: FaFire },
	bug: { color: "bg-green-700", icon: AiFillBug },
	ghost: { color: "bg-gray-500", icon: FaFire },
	steel: { color: "bg-gray-500", icon: FaFire },
